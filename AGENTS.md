...
- `mica-admin-web/` — 前端工程（Vite + Vue 3 + Naive UI）。这是 Vben Admin 5.x 的**本地化**版本，源码提取到 `mica-admin-web/_vben/`，由 pnpm workspace 协议引用。完整前端说明见 `mica-admin-web/AGENTS.md`。
...
完整说明见 `mica-admin-web/AGENTS.md`。摘要要点：
